...
<title>StoryWeaver - Releases</title>
<style>
...
.dl-link{display:inline-block;background:#4fc3f7;color:#1a1a2e;text-decoration:none;font-size:1.1rem;font-weight:600;padding:18px 48px;border-radius:10px;transition:transform .15s,box-shadow .15s}
.dl-link:hover{transform:translateY(-2px);box-shadow:0 6px 20px rgba(79,195,247,.35)}
...
<body>
<h1>StoryWeaver &mdash; Releases</h1>
<p class="sub">Latest stable build</p>
<%
try {
...
%>
<a class="dl-link" href="../download.aspx?folder=releases&file=<%= Server.UrlEncode(name) %>">Download &#8595;</a>
